...
public class ReportController {
    ...
    public byte[] getOrdersReport() {
        return getReport("report-generator/src/main/resources/static/ordersReport.pdf");
    }

    @GetMapping(value = "/products", produces = MediaType.APPLICATION_PDF_VALUE)
    @ResponseBody
    public byte[] getProductsReport() {
        return getReport("report-generator/src/main/resources/static/productsReport.pdf");
    }
